          ...
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 lg:w-1/2">
              <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div class="flex-grow sm:pl-8">
                  ...
                  <p class="mb-4">
                    Diseño y desarrollo aplicaciones móviles para iOS y Android,
                    brindando una experiencia de usuario excepcional.{" "}
                  </p>
                </div>
              </div>
            </div>
            <div class="p-4 lg:w-1/2">
              <div class=" h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div class="flex-grow sm:pl-8">
                  <h3 class="text-gray-500 mb-3">Seguridad y Mantenimiento</h3>
                  <p class="mb-4">
                    Garantizo la seguridad de tus aplicaciones web y móviles
                    mediante auditorías y proporciono mantenimiento continuo
