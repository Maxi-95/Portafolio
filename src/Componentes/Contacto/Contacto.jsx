  ...
  <div class="container px-5 mx-auto">
    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
        ...
        <svg class="h-8 w-8 text-red-500"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <rect x="3" y="5" width="18" height="14" rx="2" />  <polyline points="3 7 12 13 21 7" /></svg>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-500 text-lg title-font font-medium mb-3">Email:</h2>
          <p class="leading-relaxed text-base">maximilianofonseca19@gmail.com</p>
      ...
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
        ...
        <div class="flex-grow">
          <h2 class="text-gray-500 text-lg title-font font-medium mb-3">Telefono:</h2>
      ...
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
        ...
        <div class="flex-grow">
          <h2 class="text-gray-500 text-lg title-font font-medium mb-3">Ubicacion:</h2>
          <p class="leading-relaxed text-base">Cordoba, capita (Argentina)</p>
                ...
                <section class="text-white body-font relative">
        <div class="container px-5  mx-auto">
          <div class="flex flex-col text-center w-full pb-24 mt-6">
            <h1
              id="contacto"
              class="sm:text-4xl text-2xl font-medium title-font text-white"
            >
